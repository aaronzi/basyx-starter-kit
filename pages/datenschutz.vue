<template>
  <v-container class="legal-page py-10 px-6">
    ...
    <p>
      ...
      Details entnehmen Sie der Datenschutzerkl&auml;rung von IONOS:
      <a
    ...
    <p>
      Aaron Zielstorff<br />
      Ottomar-Geschke Str. 25a<br />
      12555 Berlin
    </p>

    <p>
      Telefon: +4916097506280<br />
      E-Mail:
      <a href="mailto:aaron.zielstorff@iese.fraunhofer.de">aaron.zielstorff@iese.fraunhofer.de</a>
    </p>
    <p>
    ...
    <p>
      ...
      Datenverarbeitung zus&auml;tzlich auf Grundlage von &sect; 25 Abs. 1 TDDDG. Die Einwilligung
    ...
    <p>
      ...
      gespeichert, bis Sie diese selbst l&ouml;schen oder eine automatische L&ouml;schung durch
    ...
    <p>
      ...
      Cookies beim Schlie&szlig;en des Browsers aktivieren. Bei der Deaktivierung von Cookies kann
      die Funktionalit&auml;t dieser Website eingeschr&auml;nkt sein.
    </p>
    <p>
      Sofern weitere Cookies und Dienste auf dieser Website eingesetzt werden, k&ouml;nnen Sie dies
